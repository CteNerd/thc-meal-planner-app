...
| 6.2 | OpenAI function calling (8 functions) | Codespaces | Not Started | Tool definitions and service dispatch not implemented yet. |
| 6.3 | System prompt builder | Codespaces | Not Started | Dynamic family/plan/grocery context injection pending. |
